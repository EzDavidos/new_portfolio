...
(function () {
  ...
  var FRAG = [
    ...
    '  float du = uv.y - ridge;',
    '  float kk = du / (du > 0.0 ? sw * 0.48 : sw * 1.16);',
    ...
    '  float lowRight = 1.0 - 0.30 * smoothstep(0.55, 0.95, uv.x) * smoothstep(0.52, 0.14, uv.y);',
    ...
    '  float thick = dens * (0.02 + 0.20 * dens) + over * 0.55;',
    '  thick *= 1.0 + 4.20 * curv + 2.60 * under;',
